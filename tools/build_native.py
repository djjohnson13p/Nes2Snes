...
def build(rom_path:Path,trace:Path,out:Path,fastrom:bool=True,quick_zp:bool=True,quick_indirect:bool=True,quick_io:bool=True,quick_ppu:bool=True,object_cache:bool=True,pipelined_video:bool=True,replay_input:Path|None=None,direct:bool=True,unrolled_objects:bool=True,experimental_audio:bool=False,stress_nmi_restore:bool=False,safe_addresses:bool=True,simple_direct:bool=True,bank_direct:bool=True,stress_bank_switch:bool=False,specialized_indirect:bool=True,audio_counters:bool=False,raster_scroll:bool=False,layer_masks:bool=True,audio_sweep:bool=False,quick_indexed:bool=True):
